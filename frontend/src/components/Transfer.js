                ...
                <div class="modal-content">
                    <form  >
                        <div class="modal-header headadd">
                            <h4 class="modal-title"> TRANSFER THE MONEY</h4>
                        ...
                        <div class="modal-body " >
                            <div class="form-group bodyadd" sytle={{ alignItems: 'center' }}>
                                <p> 
                                UserName : {mainuser.name}</p>


                            </div>
                            <div class="form-group bodyadd"style={{ alignItems: "center"}} >
                                <p> 
                               User Email: {mainuser.email}</p>


                            </div>
                            <div class="form-group bodyadd">
                                <h3> Total Balance : {mainuser.accountbalance}</h3>
                        ...
                        <button class="button" style={{ marginLeft: 150, width: 100, height: 50 , paddingTop:10 , paddingBottom:10}} type="submit" id="submit" onClick={TransferData} >Proceed</button>
